  ...
  return (
    <header className={clsx("hero hero--primary", styles.heroBanner)}>
      <div className="container">
        <h1 className="hero__title"><Translate>Caswire</Translate></h1>
        <br />
        <p className="hero__subtitle" style={{margin: "0 auto", maxWidth: 700}}>
          <Translate>
            An open-source host-based anti-virus, firewall and IDS (Intrusion Detection System) platform
          </Translate>
        </p>
        <br />
...
export default function Home() {
  return (
    <Layout
      title={"Caswire"}
      description="An open-source host-based anti-virus, firewall and IDS (Intrusion Detection System) platform">
      <HomepageHeader />
      <main>
        <HomepageFeatures />
        <Showcase />
