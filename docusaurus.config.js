...
module.exports = {
  title: "Caswire · An open-source host-based anti-virus, firewall and IDS (Intrusion Detection System) platform",
  url: "https://caswire.org",
  baseUrl: "/",
  onBrokenLinks: "throw",
  onBrokenMarkdownLinks: "warn",
  favicon: "img/favicon.png",
  organizationName: "casbin", // Usually your GitHub org/user name.
  projectName: "caswire-website", // Usually your repo name.
  i18n: {
    defaultLocale: "en",
    locales: ["en", "zh", "fr", "de", "ko", "ru", "ja"],
  },
  themeConfig: {
    metadata: [{name: "Caswire", content: "An open-source host-based anti-virus, firewall and IDS (Intrusion Detection System) platform"}],
    // algolia: {
    //   appId: "",
    //   apiKey: "",
    //   indexName: "caswire",
      ...
      items: [
        ...
        },
        {
          ...
          dropdownItemsAfter: [
            ...
            {
              to: "https://crowdin.com/project/caswire-website",
              label: "Help translate",
            },
          ],
        },
        {
          href: "https://github.com/casbin/caswire",
          position: "right",
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: "Discord",
              href: "https://discord.gg/5mdgaSZHcv",
            },
            {
              label: "QQ Group",
              href: "https://qm.qq.com/cgi-bin/qm/qr?k=MJ-2O4IMjbCX3UhccD6tlNRNSsRzfi_z&jump_from=webapi&authKey=+ZjQjYbSP9kNpddoimfMFb/ArQj2LyChrXiJAkriCdAgc7DunHyI1J1BH74J56SG",
            },
            {
              label: "Wechat Group",
        ...
        },
        {
          ...
          items: [
            ...
            {
              html: `
              <iframe src="https://ghbtns.com/github-btn.html?user=casbin&repo=caswire&type=star&count=true&size=large" frameborder="0" scrolling="0" width="170" height="30" title="GitHub">Caswire</iframe>
              `,
            },
            {
              html: `
...
(function() {
  ...
  hm.src = "https://hm.baidu.com/hm.js?b11137b8d2f71fa494bdafc26f1b609f";
...
`,
      ...
      logo: {
        ...
        href: "https://caswire.org/",
      },
      copyright: `Copyright © ${new Date().getFullYear()} Caswire contributors.`,
    },
    prism: {
