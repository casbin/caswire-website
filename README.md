# [caswire.org](https://caswire.org) [![Build and Deploy](https://github.com/casbin/caswire-website/actions/workflows/master.yml/badge.svg)](https://github.com/casbin/caswire-website/actions/workflows/master.yml)

The configuration and documentation of caswire website: <https://caswire.org/>.

caswire website is built using [Docusaurus](https://docusaurus.io/), you can get the PDF at [caswire.org/pdf](https://caswire.org/pdf) or [GitHub Action](https://github.com/casbin/caswire-website/actions/workflows/master.yml).
...
1. `git clone https://github.com/casbin/caswire-website.git`
2. `cd caswire-website`
...
[Crowdin](https://crowdin.com/project/caswire-website) and [Docusaurus i18n](https://docusaurus.io/docs/i18n/introduction) is used for caswire website's translation.
...
- Please don't translate sentences like `authors: [caswire]`.
